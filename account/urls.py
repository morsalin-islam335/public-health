...
from . views import registration, LoginView, profile, userUpdateProfile, changePassword, profile, UserLogout, activate, conformationForDeleteAccount, deleteAccount
